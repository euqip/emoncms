...
<div class="container">
        <div id="localheading">
          <h2><?php echo _('Feeds'); ?>
            ...
            <a href="#"><small><span id="refreshfeedsize" class = "glyphicon glyphicon-refresh" title = "<?php echo _('Refresh feed size'); ?>"></span></small></a>
          </h2>    
        </div>
...
<div id="ExportModal" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="ExportModalLabel" aria-hidden="true" data-backdrop="false">
    ...
    <p><?php echo _('Selected feed:') ?> <b><span id="SelectedExportFeed"></span></b></p>
