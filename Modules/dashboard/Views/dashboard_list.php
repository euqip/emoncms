...
'view-action':{'title':'','tooltip':"<?php echo _('Show the result dashboard'); ?>", 'type':"iconlink", 'link':path+"dashboard/view?id=",  'display':"<?php echo $actions['view']; ?>", 'colwidth':" style='width:30px;'"},
    ...
    'name':{'title':"<?php echo _('Name'); ?>", 'type':"textlink",'tooltip':"<?php echo _('Dashboard name'); ?>",'link':path+"dashboard/view?id=", 'display':"yes", 'colwidth':" style='width:200px;'"},
    'alias':{'title':"<?php echo _('Alias'); ?>", 'type':"textlink",'tooltip':"<?php echo _('Dashboard Alias'); ?>", 'link':path+"dashboard/view?id=", 'display':"yes", 'colwidth':" style='width:200px;'"},
