...
<script language="javascript" type="text/javascript" src="<?php echo $path.MODULE; ?>/vis/visualisations/zoom/view.js"></script>
<script language="javascript" type="text/javascript" src="<?php echo $path.MODULE; ?>/vis/visualisations/zoom/graphs.js"></script>
