...
global $path;
?>
<script language="javascript" type="text/javascript" src="<?php echo $path.MODULE; ?>/vis/multigraph_edit.js"></script>
...
<script language="javascript" type="text/javascript" src="<?php echo $path.MODULE; ?>/vis/multigraph_api.js"></script>
